<nav aria-label="Page navigation">
            <ul class="flex justify-center">
                <?php if ($currentPage > 1): ?>
                    <li><a href="?page=1" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700">Première</a></li>
                ...
                <?php if ($currentPage < $totalPages): ?>
                    ...
                    <li><a href="?page=<?= $totalPages ?>" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700">Dernière</a></li>
                <?php endif; ?>
            </ul>
        </nav>
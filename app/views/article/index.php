...
?>
    ...
    <div class="relative font-thin">
        <div class="flex flex-col mb-4">
            <h1 class="text-2xl font-medium">Articles</h1>
            <p>Bienvenue ! Découvrez notre sélection d'articles soigneusement choisis pour répondre à tous vos besoins. Parcourez, explorez, et laissez-vous inspirer !😊</p>
        </div>
        <div class="w-full">

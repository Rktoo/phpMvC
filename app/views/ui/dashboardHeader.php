...
<?php } elseif($uri === "/profil/remove-account") {?>
    ...
    <?php }; ?>
        <div class="absolute bottom-16 flex justify-center items-center gap-2 text-xs  hover:font-normal transition-colors duration-200 ease-in-out cursor-pointer _logout">
            <a href="/logout">Se déconnecter</a>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  <path d="M10 17l-5-5 5-5"/>
  <path d="M20 12H9"/>
  <path d="M14 2H5a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h9"/>
</svg>
